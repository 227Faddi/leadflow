      ...
      <div className="mb-4 flex flex-col space-y-4 sm:space-y-2">
        ...
        <div>
          ...
          <input
            ...
            className="w-full placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow dark:bg-slate-800 dark:text-white dark:border-slate-700 dark:bg-white"
          />
          <p className="text-red-700 h-4 text-sm sm:text-base">
